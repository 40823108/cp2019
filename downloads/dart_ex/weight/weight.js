...
(function dartProgram() {
  ...
  Y = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new Y.main_closure(tempInput), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    ...
    call$1: function(e) {
      ...
      if (t1 || t1) {
        ...
        if (t1) {
          ...
          if (typeof number !== "number")
            return number.$mul();
          t2.setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 0.454, 2) + " \u516c\u65a4");
        } else
