...
期中報告
----
<iframe width="560" height="315" src="https://www.youtube.com/embed/lazG4Ww9yTo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

DISQUS設定流程
----

創建DISQUS帳號(可以使用G-mail)，建完帳號會出現上下兩個框框，點選 I want to install Disqus in my site.，進入設定頁面，Website Name 填入學號_cp2019，
Category選取Tech，Language選English，確定後到下一個頁面，拉到最下面選取Stubscribe Now點選進入，進入後左方有三個選項，選第三個Configure Disqus，
進入設定後Website URL 填入 "http://學號.github.io/cp2019"，存檔後進入下一 介面，點選正中間Configure your site's community strrings，之後在Shortname後面會有一串剛剛輸入的網址"http://學號.github.io/cp2019"，將他複製到遠端更改SITEURL存檔後結束。
